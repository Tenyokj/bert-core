...
Core modules:
1. [IdeaRegistryUpgradeable](../contracts/BERT/docs_contracts/IdeaRegistryUpgradeable.md)
2. [VotingSystemUpgradeable](../contracts/BERT/docs_contracts/VotingSystemUpgradeable.md)
3. [FundingPoolUpgradeable](../contracts/BERT/docs_contracts/FundingPoolUpgradeable.md)
...
3. [ReputationSystemUpgradeable](../contracts/BERT/docs_contracts/ReputationSystemUpgradeable.md)
